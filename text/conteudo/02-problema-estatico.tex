...
%Como podemos obter uma ABB ótima a partir de ABBs ótimas menores, então a única preocupação do algoritmo construtor de uma tal ABB deve ser a escolha da chave da raiz que minimize a soma acima.
