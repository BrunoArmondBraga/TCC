...
\begin{figure}
    ...
    \begin{tikzpicture}[scale=0.85]
        ...
        \draw[black, line width=0.5pt] (0,0) rectangle (6,6);
    \end{tikzpicture}
    \caption{À esquerda, está destacado o funil do ponto azul. À direita, está destacado o funil do ponto de mesma altura no conjunto de pontos espelhados em relação ao eixo $Y$. Perceba que em ambos os casos há o mesmo número de intercalações entre os funis esquerdo e direito do ponto azul.}
\label{fig:espelhamento-de-funil}
\end{figure}
